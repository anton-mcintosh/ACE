    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.Main}>
                <TextInput placeholder='Brief Description...       ' placeholderTextColor='#FEFEFE' style={styles.Input} ></TextInput>
            </View>
                <TouchableOpacity>
        <FontAwesome5 style={styles.icon} name='microphone-alt' size={40} marginTop={30} marginLeft={-90} />
      </TouchableOpacity>
